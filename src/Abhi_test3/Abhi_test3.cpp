...
int ConfigureTrigger(INodeMap & nodeMap)
{
	...
	try
	{
        ...
        // Setting trigger selector to FrameBurst Mode
        ...
        CEnumEntryPtr ptrTriggerSelectorSel = ptrTriggerSelector->GetEntryByName("AcquisitionStart");
...
int GrabNextImageByTrigger(INodeMap & nodeMap, CameraPtr pCam)
{
	...
	try
	{
		...
		else if (chosenTrigger == HARDWARE)
		{
            ...
            //TODO: I need some trigger code here?
		}
	}
	catch (Spinnaker::Exception &e)
	{
...
int ConfigureCamera(CameraPtr pCam, INodeMap & nodeMap) {
        ...
        try {
                ...
                double exposureTimeToSet = 1500.0;
...
int AcquireImages(CameraList camList)
{
        ...
        try
        {
                ...
                //vector<INodeMap> nodeMapList;
                INodeMap & nodeMapList[camList.GetSize()];

                for(int i = 0; i<camList.GetSize(); ++i) {
                    INodeMap & nodeMap = camList.GetByIndex(i)->GetNodeMap();
                    nodeMapList[i] = nodeMap;
                }
#endif
				...
				// Select camera
                                ...
                                try
                                {
                                        ...
                                        else
                                        {
                                                ...
                                                Mat src = Mat(convertedImage->GetHeight(),
                                                                convertedImage->GetWidth(), CV_8UC3, convertedImage->GetData(),
                                                                rowBytes);
